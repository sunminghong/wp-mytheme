...
<div class="kratos-post-inner">
	<header class="kratos-entry-header clearfix">
		...
		<div class="kratos-post-meta">
			...
			<a href="<?php the_permalink() ?>#respond"><i class="fa fa-commenting-o"></i> <?php echo kratos_comments_users($post->ID); ?></a>
			</span>
			<span class="pull-left">
			<a href="<?php the_permalink() ?>"><i class="fa fa-eye"></i> <?php echo kratos_get_post_views(); ?></a>
			<a href="<?php the_permalink() ?>"><i class="fa fa-thumbs-o-up"></i> <?php if( get_post_meta($post->ID,'love',true) ){ echo get_post_meta($post->ID,'love',true); } else { echo '0'; }?></a>
			</span>
		</div>
	</header>
...
<div class="kratos-entry-border-new clearfix">
	<?php $thu = kratos_blog_thumbnail_new_smh();
if ($thu===''){
	$c_ls="kratos-post-inner-new kratos-post-inner-new-full";
} else {
	$c_ls="kratos-post-inner-new"; ?>
	<div class="kratos-entry-thumb-new">
		<?php echo $thu; ?>
	</div>
<?php } ?>
	<div class="<?php echo $c_ls;?>">
	...
	<div class="kratos-post-meta-new">
		...
		<span class="pull-left">
			<a href="<?php the_permalink() ?>"><i class="fa fa-eye"></i> <?php echo kratos_get_post_views(); ?></a>
			<a href="<?php the_permalink() ?>"><i class="fa fa-thumbs-o-up"></i> <?php if( get_post_meta($post->ID,'love',true) ){ echo get_post_meta($post->ID,'love',true); } else { echo '0'; }?></a>
			<a href="<?php the_permalink() ?>"><?php echo get_the_author_meta('nickname'); ?>
			 @ <?php the_time('m-d H:m') ?></a>
		</span>
