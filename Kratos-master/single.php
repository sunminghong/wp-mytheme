					...
					<div class="kratos-hentry kratos-post-inner clearfix">
						<header class="kratos-entry-header">
							...
							<div class="kratos-post-meta text-center">
								<span>
				                <i class="fa fa-commenting-o"></i> <?php echo kratos_comments_users($post->ID); ?> 
				                <i class="fa fa-eye"></i> <?php echo kratos_get_post_views();?> 
				                <i class="fa fa-thumbs-o-up"></i> <?php if( get_post_meta($post->ID,'love',true) ){ echo get_post_meta($post->ID,'love',true); } else { echo '0'; }?> 
 <span style="padding-left:30px;">by <?php echo get_the_author_meta('nickname');?> @ 
								<?php the_time('m-d H:m:s') ?>
								</span>
							</div>
						</header>
	                    ...
	                    <?php endif ?>
                        <?php the_content(); ?>
 <div style="font-size:16px;text-align:right;color:#ccc;">by <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php echo get_the_author_meta('nickname'); ?></a></div>
 <div style="font-size:12px;text-align:right;color:#ccc;">@ <?php the_time('Y-m-d H:m:s') ?></div>
                        <?php if ($ad['footer']==1): ?>
	                    <img src="<?php echo kratos_option('ad_img')?>">
	                    <?php endif ?>
						</div>
